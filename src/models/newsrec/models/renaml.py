...
from src.models.newsrec.models.layers import AttLayer2, AttLayer

__all__ = ["RENAMLModel"]


class RENAMLModel(BaseModel):
    ...
    def _build_userencoder(self, newsencoder):
        ...
        user_present = AttLayer(hparams.attention_hidden_dim, seed=self.seed, name="attention")(
            click_news_presents
        )
        ...
        self.att = model.get_layer("attention")
        return model
